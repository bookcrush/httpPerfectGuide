...
- 가상 호스팅된 docroot: URI나 Host 헤더에서 얻은 IP 주소나 호스트 명을 이용해 올바른 문서 루트를 식별합니다. 하나의 웹 서버 위에서 두 개의 사이트가 분리된 컨텐츠를 갖고 호스팅 되도록 할 수 있습니다.
...
성공 메세지 대신 리다이렉션 응답을 반환할 수 있습니다.
